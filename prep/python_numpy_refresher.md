...
Pasa esto si escribes Python regularmente. De lo contrario, lee esto antes del resumen.
...
grid = [[0.0] * 4 for _ in range(3)]    # una lista de 3 listas de 4 ceros
grid[0][1] = 100.0                      # fila 0, columna 1
...
print(np.allclose(a * 0.5 * 2, a))      # True: compara floats con una tolerancia
```
...
- Las variables definidas en una celda se disponen en las celdas posteriores, hasta que reinicie el
  entorno de ejecución. Después de una reinicialización, ejecuta desde el principio.
